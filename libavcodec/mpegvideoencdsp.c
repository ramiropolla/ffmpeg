...
static av_always_inline void draw_edges_h_8(uint8_t *ptr, int wrap, int width, int height, int w)
{
    /* left and right */
                           ...
                           int w, int h, int sides)
{
    ...
    if (w == 16) {
        draw_edges_h_8(buf, wrap, width, height, 16);
    } else if (w == 8) {
        draw_edges_h_8(buf, wrap, width, height, 8);
    } else {
        av_assert1(w == 4);
        draw_edges_h_8(buf, wrap, width, height, 4);
    }
