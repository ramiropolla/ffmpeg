                               ...
                               int64_t coeff, int offset, int amax)
{
    ...
    int32_t *dst = (int32_t *) _dst;
    for (i = 0; i < width; i++) {
        dst[i] = ((int)(FFMIN(dst[i], amax) * coeff + offset)) >> 14;
    }
}
...
static void solve_range_convert(int src_min, int src_max,
                                ...
                                int src_shift, int mult_shift,
                                int64_t *pcoeff, int *poffset, int *pmax)
{
    ...
    int coeff = AV_CEIL_RSHIFT(((int64_t) dst_range << total_shift) / src_range, src_shift);
    int64_t offset = ((int64_t) dst_max << total_shift) -
...
static void init_range_convert_constants(SwsContext *c)
{
    ...
    const int src_shift = bit_depth <= 14 ? 15 - bit_depth : 19 - bit_depth;
    const int mult_shift = bit_depth <= 14 ? 14 : 16;
    ...
    if (c->srcRange) {
        solve_range_convert(0, jpeg_max, mpeg_min, mpeg_max_lum,
                            src_shift, mult_shift,
                            &c->lumConvertRange_coeff, &c->lumConvertRange_offset,
                            &c->lumConvertRange_max);
        solve_range_convert(0, jpeg_max, mpeg_min, mpeg_max_chr,
                            src_shift, mult_shift,
                            &c->chrConvertRange_coeff, &c->chrConvertRange_offset,
                            &c->chrConvertRange_max);
    } else {
        solve_range_convert(mpeg_min, mpeg_max_lum, 0, jpeg_max,
                            src_shift, mult_shift,
                            &c->lumConvertRange_coeff, &c->lumConvertRange_offset,
                            &c->lumConvertRange_max);
        solve_range_convert(mpeg_min, mpeg_max_chr, 0, jpeg_max,
                            src_shift, mult_shift,
                            &c->chrConvertRange_coeff, &c->chrConvertRange_offset,
                            &c->chrConvertRange_max);
    }
