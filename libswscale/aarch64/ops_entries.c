...
ENTRY(ff_sws_move_000032120120_8_u8_1111_neon, { .uop = SWS_UOP_MOVE, .par.move = { .num_moves = 4, .dst = {2, 0, 1, 3, 0, 0}, .src = {0, 1, 2, 2, 0, 0} }, .block_size = 8, .type = SWS_PIXEL_U8, .mask = 0xf })
...
ENTRY(ff_sws_move_000032120120_16_u8_1111_neon, { .uop = SWS_UOP_MOVE, .par.move = { .num_moves = 4, .dst = {2, 0, 1, 3, 0, 0}, .src = {0, 1, 2, 2, 0, 0} }, .block_size = 16, .type = SWS_PIXEL_U8, .mask = 0xf })
