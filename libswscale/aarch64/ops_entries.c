...
ENTRY(ff_sws_clear_ffff_8_u8_0001_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U8, .mask = 0x0001 })
ENTRY(ff_sws_clear_ffff_8_u8_0010_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U8, .mask = 0x0010 })
...
ENTRY(ff_sws_clear_ffff_8_u8_1000_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U8, .mask = 0x1000 })
ENTRY(ff_sws_clear_ffff_8_u8_1011_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U8, .mask = 0x1011 })
...
ENTRY(ff_sws_clear_ffff_8_u8_1101_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U8, .mask = 0x1101 })
ENTRY(ff_sws_clear_ffff_8_u8_1110_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U8, .mask = 0x1110 })
ENTRY(ff_sws_clear_ffff_8_u16_0001_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U16, .mask = 0x0001 })
ENTRY(ff_sws_clear_ffff_8_u16_0010_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U16, .mask = 0x0010 })
...
ENTRY(ff_sws_clear_ffff_8_u16_1101_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_U16, .mask = 0x1101 })
...
ENTRY(ff_sws_clear_ffff_8_f32_0010_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_F32, .mask = 0x0010 })
ENTRY(ff_sws_clear_ffff_8_f32_1000_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 8, .type = AARCH64_PIXEL_F32, .mask = 0x1000 })
ENTRY(ff_sws_clear_ffff_16_u8_0001_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 16, .type = AARCH64_PIXEL_U8, .mask = 0x0001 })
ENTRY(ff_sws_clear_ffff_16_u8_0010_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 16, .type = AARCH64_PIXEL_U8, .mask = 0x0010 })
...
ENTRY(ff_sws_clear_ffff_16_u8_1000_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 16, .type = AARCH64_PIXEL_U8, .mask = 0x1000 })
...
ENTRY(ff_sws_clear_ffff_16_u16_0010_neon, { .op = AARCH64_SWS_OP_CLEAR, .clear = 0xffff, .block_size = 16, .type = AARCH64_PIXEL_U16, .mask = 0x0010 })
...
ENTRY(ff_sws_linear_fma_000000000d_1_8_f32_0001_neon, { .op = AARCH64_SWS_OP_LINEAR_FMA, .linear.mask = 0x000000000dULL, .linear.fmla = 1, .block_size = 8, .type = AARCH64_PIXEL_F32, .mask = 0x0001 })
...
ENTRY(ff_sws_linear_fma_00000000fd_1_8_f32_0001_neon, { .op = AARCH64_SWS_OP_LINEAR_FMA, .linear.mask = 0x00000000fdULL, .linear.fmla = 1, .block_size = 8, .type = AARCH64_PIXEL_F32, .mask = 0x0001 })
...
ENTRY(ff_sws_linear_fma_000c10c40d_1_8_f32_0111_neon, { .op = AARCH64_SWS_OP_LINEAR_FMA, .linear.mask = 0x000c10c40dULL, .linear.fmla = 1, .block_size = 8, .type = AARCH64_PIXEL_F32, .mask = 0x0111 })
ENTRY(ff_sws_linear_fma_000c10cc0d_1_8_f32_0111_neon, { .op = AARCH64_SWS_OP_LINEAR_FMA, .linear.mask = 0x000c10cc0dULL, .linear.fmla = 1, .block_size = 8, .type = AARCH64_PIXEL_F32, .mask = 0x0111 })
