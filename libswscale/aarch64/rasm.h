...
static inline int a64reg_arg(AArch64RegState *rs, int argnum)
{
    ...
    return a64reg_unused_gpr(rs, argnum);
}
...
static inline RasmOp a64reg_gpx            (AArch64RegState *rs, int r)      { return a64op_gpx(a64reg_unused_gpr(rs, r)); }
static inline RasmOp a64reg_gpw            (AArch64RegState *rs, int r)      { return a64op_gpw(a64reg_unused_gpr(rs, r)); }
static inline RasmOp a64reg_unclobbered_gpx(AArch64RegState *rs)             { return a64op_gpx(a64reg_unclobbered_gpr(rs)); }
static inline RasmOp a64reg_unclobbered_gpw(AArch64RegState *rs)             { return a64op_gpw(a64reg_unclobbered_gpr(rs)); }
