...
int a64reg_gpr(AArch64RegState *rs, int r);
...
static inline RasmOp a64reg_gpx (AArch64RegState *rs, int r)      { return a64op_gpx(a64reg_gpr(rs, r)); }
static inline RasmOp a64reg_gpw (AArch64RegState *rs, int r)      { return a64op_gpw(a64reg_gpr(rs, r)); }
