...
void rasm_free(RasmContext **p_actx);
...
RasmNode *rasm_add_commentf(RasmContext *actx, char *s, size_t n,
...
/* Suported AArch64 operand types */
...
{
    assert(rasm_op_type(op0) != RASM_OP_NONE);
    uint8_t num_regs = 1;
...
#define i_none(actx                      ) rasm_add_insn(actx, AARCH64_INSN_NONE,   OPN, OPN, OPN, OPN)

#define i_add(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_ADD,    op0, op1, op2, OPN)
#define i_addv(actx,   op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_ADDV,   op0, op1, OPN, OPN)
#define i_adr(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_ADR,    op0, op1, OPN, OPN)
#define i_and(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_AND,    op0, op1, op2, OPN)
#define i_b(actx,      op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_B,      op0, op1, OPN, OPN)
#define i_br(actx,     op0               ) rasm_add_insn(actx, AARCH64_INSN_BR,     op0, OPN, OPN, OPN)
#define i_cmp(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_CMP,    op0, op1, OPN, OPN)
#define i_csel(actx,   op0, op1, op2, op3) rasm_add_insn(actx, AARCH64_INSN_CSEL,   op0, op1, op2, op3)
#define i_dup(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_DUP,    op0, op1, OPN, OPN)
#define i_fadd(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_FADD,   op0, op1, op2, OPN)
#define i_fcvtzu(actx, op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_FCVTZU, op0, op1, OPN, OPN)
#define i_fmax(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_FMAX,   op0, op1, op2, OPN)
#define i_fmin(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_FMIN,   op0, op1, op2, OPN)
#define i_fmla(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_FMLA,   op0, op1, op2, OPN)
#define i_fmul(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_FMUL,   op0, op1, op2, OPN)
#define i_ins(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_INS,    op0, op1, OPN, OPN)
#define i_ld1(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LD1,    op0, op1, OPN, OPN)
#define i_ld1r(actx,   op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LD1R,   op0, op1, OPN, OPN)
#define i_ld2(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LD2,    op0, op1, OPN, OPN)
#define i_ld3(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LD3,    op0, op1, OPN, OPN)
#define i_ld4(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LD4,    op0, op1, OPN, OPN)
#define i_ldp(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_LDP,    op0, op1, op2, OPN)
#define i_ldr(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LDR,    op0, op1, OPN, OPN)
#define i_ldrb(actx,   op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LDRB,   op0, op1, OPN, OPN)
#define i_ldrh(actx,   op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_LDRH,   op0, op1, OPN, OPN)
#define i_lsr(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_LSR,    op0, op1, op2, OPN)
#define i_mov(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_MOV,    op0, op1, OPN, OPN)
#define i_movi(actx,   op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_MOVI,   op0, op1, OPN, OPN)
#define i_mul(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_MUL,    op0, op1, op2, OPN)
#define i_orr(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_ORR,    op0, op1, op2, OPN)
#define i_ret(actx                       ) rasm_add_insn(actx, AARCH64_INSN_RET,    OPN, OPN, OPN, OPN)
#define i_rev16(actx,  op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_REV16,  op0, op1, OPN, OPN)
#define i_rev32(actx,  op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_REV32,  op0, op1, OPN, OPN)
#define i_shl(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_SHL,    op0, op1, op2, OPN)
#define i_st1(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_ST1,    op0, op1, OPN, OPN)
#define i_st2(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_ST2,    op0, op1, OPN, OPN)
#define i_st3(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_ST3,    op0, op1, OPN, OPN)
#define i_st4(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_ST4,    op0, op1, OPN, OPN)
#define i_stp(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_STP,    op0, op1, op2, OPN)
#define i_str(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_STR,    op0, op1, OPN, OPN)
#define i_sub(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_SUB,    op0, op1, op2, OPN)
#define i_subs(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_SUBS,   op0, op1, op2, OPN)
#define i_tbl(actx,    op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_TBL,    op0, op1, op2, OPN)
#define i_ubfiz(actx,  op0, op1, op2, op3) rasm_add_insn(actx, AARCH64_INSN_UBFIZ,  op0, op1, op2, op3)
#define i_ucvtf(actx,  op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_UCVTF,  op0, op1, OPN, OPN)
#define i_umax(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_UMAX,   op0, op1, op2, OPN)
#define i_umin(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_UMIN,   op0, op1, op2, OPN)
#define i_uqxtn(actx,  op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_UQXTN,  op0, op1, OPN, OPN)
#define i_ushl(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_USHL,   op0, op1, op2, OPN)
#define i_ushll(actx,  op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_USHLL,  op0, op1, op2, OPN)
#define i_ushll2(actx, op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_USHLL2, op0, op1, op2, OPN)
#define i_ushr(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_USHR,   op0, op1, op2, OPN)
#define i_uxtl(actx,   op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_UXTL,   op0, op1, OPN, OPN)
#define i_uxtl2(actx,  op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_UXTL2,  op0, op1, OPN, OPN)
#define i_xtn(actx,    op0, op1          ) rasm_add_insn(actx, AARCH64_INSN_XTN,    op0, op1, OPN, OPN)
#define i_zip1(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_ZIP1,   op0, op1, op2, OPN)
#define i_zip2(actx,   op0, op1, op2     ) rasm_add_insn(actx, AARCH64_INSN_ZIP2,   op0, op1, op2, OPN)

/* Branch helpers. */
#define i_beq(actx, id) i_b(actx, a64cond_eq(), rasm_op_label(id))
#define i_bne(actx, id) i_b(actx, a64cond_ne(), rasm_op_label(id))
#define i_bhs(actx, id) i_b(actx, a64cond_hs(), rasm_op_label(id))
#define i_bcs(actx, id) i_b(actx, a64cond_cs(), rasm_op_label(id))
#define i_blo(actx, id) i_b(actx, a64cond_lo(), rasm_op_label(id))
#define i_bcc(actx, id) i_b(actx, a64cond_cc(), rasm_op_label(id))
#define i_bmi(actx, id) i_b(actx, a64cond_mi(), rasm_op_label(id))
#define i_bpl(actx, id) i_b(actx, a64cond_pl(), rasm_op_label(id))
#define i_bvs(actx, id) i_b(actx, a64cond_vs(), rasm_op_label(id))
#define i_bvc(actx, id) i_b(actx, a64cond_vc(), rasm_op_label(id))
#define i_bhi(actx, id) i_b(actx, a64cond_hi(), rasm_op_label(id))
#define i_bls(actx, id) i_b(actx, a64cond_ls(), rasm_op_label(id))
#define i_bge(actx, id) i_b(actx, a64cond_ge(), rasm_op_label(id))
#define i_blt(actx, id) i_b(actx, a64cond_lt(), rasm_op_label(id))
#define i_bgt(actx, id) i_b(actx, a64cond_gt(), rasm_op_label(id))
#define i_ble(actx, id) i_b(actx, a64cond_le(), rasm_op_label(id))
