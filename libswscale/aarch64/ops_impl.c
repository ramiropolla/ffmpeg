...
const char *sws_aarch64_op_type(SwsAArch64OpType op)
{
    ...
    case AARCH64_SWS_OP_READ:           return "AARCH64_SWS_OP_READ";
    case AARCH64_SWS_OP_WRITE:          return "AARCH64_SWS_OP_WRITE";
...
const char *sws_aarch64_op_type_name(SwsAArch64OpType op)
{
    ...
    case AARCH64_SWS_OP_READ:           return "read";
    case AARCH64_SWS_OP_WRITE:          return "write";
...
{
    switch (rw) {
    case AARCH64_SWS_OP_RW_BIT:    return "AARCH64_SWS_OP_RW_BIT";
    case AARCH64_SWS_OP_RW_NIBBLE: return "AARCH64_SWS_OP_RW_NIBBLE";
    case AARCH64_SWS_OP_RW_PACKED: return "AARCH64_SWS_OP_RW_PACKED";
    case AARCH64_SWS_OP_RW_PLANAR: return "AARCH64_SWS_OP_RW_PLANAR";
    }
    assert(!"Invalid rw op type!");
    return NULL;
}
...
{
    switch (rw) {
    case AARCH64_SWS_OP_RW_BIT:    return "bit";
    case AARCH64_SWS_OP_RW_NIBBLE: return "nibble";
    case AARCH64_SWS_OP_RW_PACKED: return "packed";
    case AARCH64_SWS_OP_RW_PLANAR: return "planar";
    }
    assert(!"Invalid rw op type!");
    return NULL;
}
...
void sws_aarch64_op_impl_func_name(char *buf, size_t size, const SwsAArch64OpImplParams *params)
{
    ...
    case AARCH64_SWS_OP_WRITE:
        buf_appendf(&buf, &size, "_%s", sws_aarch64_op_rw_type_name(params->rw));
        break;
...
void sws_aarch64_op_impl_serialize(char *buf, size_t size, const SwsAArch64OpImplParams *params)
{
    ...
    case AARCH64_SWS_OP_READ:
    case AARCH64_SWS_OP_WRITE:
        buf_appendf(&buf, &size, ", .rw = %s", sws_aarch64_op_rw_type(params->rw));
        break;
    case AARCH64_SWS_OP_SWIZZLE:
...
void sws_aarch64_op_impl_cond_str(char *buf, size_t size, const SwsAArch64OpImplParams *params, const char *p_str)
{
    ...
    case AARCH64_SWS_OP_READ:
    case AARCH64_SWS_OP_WRITE:
        buf_appendf(&buf, &size, " && %srw == %s", p_str, sws_aarch64_op_rw_type(params->rw));
        break;
    case AARCH64_SWS_OP_SWIZZLE:
