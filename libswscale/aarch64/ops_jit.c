...
/*********************************************************************/
static int jit_gpr(SwsAArch64JITContext *s, int r)
{
    if (r < 0) {
        if (!s->used_gprs)
            return -1;
...
static RasmOp jit_gpw(SwsAArch64JITContext *s, int r)
{
    r = jit_gpr(s, r);
    if (r < 0)
        return rasm_op_none();
...
static RasmOp jit_gpx(SwsAArch64JITContext *s, int r)
{
    r = jit_gpr(s, r);
    if (r < 0)
        return rasm_op_none();
...
static void jit_free_gpr(SwsAArch64JITContext *s, RasmOp op)
{
...
static void reshape_all_vectors(SwsAArch64JITContext *s, int el_count, int el_size)
{
...
static void asmgen_prologue(SwsAArch64JITContext *s, const RasmOp *regs, unsigned n)
{
...
static void asmgen_epilogue(SwsAArch64JITContext *s, const RasmOp *regs, unsigned n)
{
    RasmContext *r = s->rctx;
    RasmOp sp = a64op_sp();
    unsigned frame_size = clobbered_frame_size(n);
...
static unsigned clobbered_gprs(const SwsAArch64JITContext *s,
                               SwsCompMask mask,
...
static int aarch64_jit_process(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *pin, const SwsAArch64OpImplParams *pout)
{
...
static void asmgen_op_read_bit(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
...
static void asmgen_op_read_nibble(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
...
static void asmgen_op_read_packed_n(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p, RasmOp *vx)
{
    RasmContext *r = s->rctx;
...
static void asmgen_op_read_packed(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
...
static void asmgen_op_read_planar(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
...
static void asmgen_op_write_bit(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    AArch64VecViews vl[1];
    AArch64VecViews shift_vec;
...
static void asmgen_op_write_nibble(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    AArch64VecViews vl[4];
    AArch64VecViews vtmp0;
...
static void asmgen_op_write_packed_n(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p, RasmOp *vx)
{
    RasmContext *r = s->rctx;
...
static void asmgen_op_write_packed(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    av_assert0(p->mask != 0x0001);
...
static void asmgen_op_write_planar(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    AArch64VecViews vl[4];
    AArch64VecViews vh[4];
...
static void asmgen_op_swap_bytes(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    AArch64VecViews vl[4];
    AArch64VecViews vh[4];
...
static RasmOp swizzle_a64op(SwsAArch64JITContext *s, int8_t n, uint8_t vh)
{
    if (n == -1)
        return s->vt[vh];
...
static void swizzle_emit(SwsAArch64JITContext *s, int8_t dst, int8_t src)
{
    RasmContext *r = s->rctx;
...
static void asmgen_op_move(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
...
static void asmgen_op_unpack(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
    RasmOp *vh = s->vh;
...
static void asmgen_op_pack(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
    RasmOp *vh = s->vh;
...
static void asmgen_op_lshift(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
...
static void asmgen_op_rshift(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    uint8_t shift = p->par.shift.amount;
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
...
static void emit_clear(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p,
...
static void asmgen_op_clear(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp clear_vec = s->vt[0];
...
static void asmgen_op_convert(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    AArch64VecViews vl[4];
    AArch64VecViews vh[4];
...
static void asmgen_op_expand(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
    RasmOp *vh = s->vh;
...
static void asmgen_op_min(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
    RasmOp *vh = s->vh;
...
static void asmgen_op_max(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
    RasmOp *vh = s->vh;
...
static void asmgen_op_scale(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
    RasmOp *vh = s->vh;
 ...
 * (low or high).
 */
static void linear_pass(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p,
                        RasmOp *vt, RasmOp *vc,
...
static void asmgen_op_linear(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vt = s->vt;
...
static void asmgen_op_dither(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
    RasmOp *vl = s->vl;
    RasmOp *vh = s->vh;
...
static int aarch64_jit_uop(SwsAArch64JITContext *s, const SwsAArch64OpImplParams *p)
{
    RasmContext *r = s->rctx;
                               ...
                               SwsCompiledOp *out)
{
    ...
    /* Scratch registers. */
    s.tmp0      = jit_gpx(16); /* IP0 */
    s.tmp1      = jit_gpx(17); /* IP1 */

    /* Read/Write data pointers and padding. */
    s.in      [0] = jit_gpx(9);
    s.out     [0] = jit_gpx(10);
    s.in_bump [0] = jit_gpx(11);
    s.out_bump[0] = jit_gpx(12);
    s.in      [1] = jit_gpx(13);
    s.out     [1] = jit_gpx(14);
    s.in_bump [1] = jit_gpx(15);
    s.out_bump[1] = jit_gpx(19);
    s.in      [2] = jit_gpx(20);
    s.out     [2] = jit_gpx(21);
    s.in_bump [2] = jit_gpx(22);
    s.out_bump[2] = jit_gpx(23);
    s.in      [3] = jit_gpx(24);
    s.out     [3] = jit_gpx(25);
    s.in_bump [3] = jit_gpx(26);
    s.out_bump[3] = jit_gpx(27);
#endif
    ...
    for (int i = 0; i < ops->num_ops; i++) {
        ret = aarch64_jit_uop(&s, &params[i]);
        if (ret < 0)
            goto error;
    }
