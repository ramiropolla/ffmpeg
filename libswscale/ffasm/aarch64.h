...
typedef struct AArch64NodeList {
    AArch64Node *nodes;
    int num_nodes;
} AArch64NodeList;
...
static inline AArch64Op a64op_veclist(AArch64Op op, uint8_t num_regs)
{
    op.u8[4] = num_regs;
    return op;
}

static inline AArch64Op a64op_veclist2(AArch64Op v0, AArch64Op v1)
{
    av_assert0((a64op_vec_n(v0) + 1) % 32 == a64op_vec_n(v1));
    return a64op_veclist(v0, 2);
}

static inline AArch64Op a64op_veclist3(AArch64Op v0, AArch64Op v1, AArch64Op v2)
{
    av_assert0((a64op_vec_n(v0) + 1) % 32 == a64op_vec_n(v1));
    av_assert0((a64op_vec_n(v1) + 1) % 32 == a64op_vec_n(v2));
    return a64op_veclist(v0, 3);
}

static inline AArch64Op a64op_veclist4(AArch64Op v0, AArch64Op v1, AArch64Op v2, AArch64Op v3)
{
    av_assert0((a64op_vec_n(v0) + 1) % 32 == a64op_vec_n(v1));
    av_assert0((a64op_vec_n(v1) + 1) % 32 == a64op_vec_n(v2));
    av_assert0((a64op_vec_n(v2) + 1) % 32 == a64op_vec_n(v3));
...
static inline AArch64Op a64op_8h (AArch64Op op) { return a64op_vec8h (a64op_vec_n(op)); }
static inline AArch64Op a64op_2s (AArch64Op op) { return a64op_vec2s (a64op_vec_n(op)); }
static inline AArch64Op a64op_4s (AArch64Op op) { return a64op_vec4s (a64op_vec_n(op)); }
static inline AArch64Op a64op_2d (AArch64Op op) { return a64op_vec2d (a64op_vec_n(op)); }
...
#define a64insn_none(actx                      ) aarch64_add_insn(actx, AARCH64_INSN_NONE,   OPN, OPN, OPN, OPN)

#define a64insn_add(actx,    op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_ADD,    op0, op1, op2, OPN)
#define a64insn_addv(actx,   op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_ADDV,   op0, op1, OPN, OPN)
...
#define a64insn_fadd(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_FADD,   op0, op1, op2, OPN)
#define a64insn_fcvtzu(actx, op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_FCVTZU, op0, op1, OPN, OPN)
#define a64insn_fmax(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_FMAX,   op0, op1, op2, OPN)
#define a64insn_fmin(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_FMIN,   op0, op1, op2, OPN)
#define a64insn_fmla(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_FMLA,   op0, op1, op2, OPN)
#define a64insn_fmul(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_FMUL,   op0, op1, op2, OPN)
#define a64insn_ins(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_INS,    op0, op1, OPN, OPN)
#define a64insn_ld1(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_LD1,    op0, op1, OPN, OPN)
#define a64insn_ld2(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_LD2,    op0, op1, OPN, OPN)
#define a64insn_ld3(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_LD3,    op0, op1, OPN, OPN)
#define a64insn_ld4(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_LD4,    op0, op1, OPN, OPN)
#define a64insn_ldp(actx,    op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_LDP,    op0, op1, op2, OPN)
#define a64insn_ldr(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_LDR,    op0, op1, OPN, OPN)
#define a64insn_ldrh(actx,   op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_LDRH,   op0, op1, OPN, OPN)
#define a64insn_lsr(actx,    op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_LSR,    op0, op1, op2, OPN)
#define a64insn_mov(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_MOV,    op0, op1, OPN, OPN)
...
#define a64insn_st1(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_ST1,    op0, op1, OPN, OPN)
#define a64insn_st2(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_ST2,    op0, op1, OPN, OPN)
#define a64insn_st3(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_ST3,    op0, op1, OPN, OPN)
#define a64insn_st4(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_ST4,    op0, op1, OPN, OPN)
#define a64insn_stp(actx,    op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_STP,    op0, op1, op2, OPN)
#define a64insn_str(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_STR,    op0, op1, OPN, OPN)
#define a64insn_sub(actx,    op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_SUB,    op0, op1, op2, OPN)
#define a64insn_subs(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_SUBS,   op0, op1, op2, OPN)
#define a64insn_tbl(actx,    op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_TBL,    op0, op1, op2, OPN)
#define a64insn_ubfiz(actx,  op0, op1, op2, op3) aarch64_add_insn(actx, AARCH64_INSN_UBFIZ,  op0, op1, op2, op3)
#define a64insn_ucvtf(actx,  op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_UCVTF,  op0, op1, OPN, OPN)
#define a64insn_umin(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_UMIN,   op0, op1, op2, OPN)
#define a64insn_uqxtn(actx,  op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_UQXTN,  op0, op1, OPN, OPN)
#define a64insn_ushl(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_USHL,   op0, op1, op2, OPN)
#define a64insn_ushll(actx,  op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_USHLL,  op0, op1, op2, OPN)
#define a64insn_ushll2(actx, op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_USHLL2, op0, op1, op2, OPN)
#define a64insn_ushr(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_USHR,   op0, op1, op2, OPN)
#define a64insn_uxtl(actx,   op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_UXTL,   op0, op1, OPN, OPN)
#define a64insn_uxtl2(actx,  op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_UXTL2,  op0, op1, OPN, OPN)
#define a64insn_xtn(actx,    op0, op1          ) aarch64_add_insn(actx, AARCH64_INSN_XTN,    op0, op1, OPN, OPN)
#define a64insn_zip1(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_ZIP1,   op0, op1, op2, OPN)
#define a64insn_zip2(actx,   op0, op1, op2     ) aarch64_add_insn(actx, AARCH64_INSN_ZIP2,   op0, op1, op2, OPN)

/* branch helpers */
#define a64insn_beq(actx, id) a64insn_b(actx, a64cond_eq(), a64op_label(id))
#define a64insn_bne(actx, id) a64insn_b(actx, a64cond_ne(), a64op_label(id))
#define a64insn_bhs(actx, id) a64insn_b(actx, a64cond_hs(), a64op_label(id))
#define a64insn_bcs(actx, id) a64insn_b(actx, a64cond_cs(), a64op_label(id))
#define a64insn_blo(actx, id) a64insn_b(actx, a64cond_lo(), a64op_label(id))
#define a64insn_bcc(actx, id) a64insn_b(actx, a64cond_cc(), a64op_label(id))
#define a64insn_bmi(actx, id) a64insn_b(actx, a64cond_mi(), a64op_label(id))
#define a64insn_bpl(actx, id) a64insn_b(actx, a64cond_pl(), a64op_label(id))
#define a64insn_bvs(actx, id) a64insn_b(actx, a64cond_vs(), a64op_label(id))
#define a64insn_bvc(actx, id) a64insn_b(actx, a64cond_vc(), a64op_label(id))
#define a64insn_bhi(actx, id) a64insn_b(actx, a64cond_hi(), a64op_label(id))
#define a64insn_bls(actx, id) a64insn_b(actx, a64cond_ls(), a64op_label(id))
#define a64insn_bge(actx, id) a64insn_b(actx, a64cond_ge(), a64op_label(id))
#define a64insn_blt(actx, id) a64insn_b(actx, a64cond_lt(), a64op_label(id))
#define a64insn_bgt(actx, id) a64insn_b(actx, a64cond_gt(), a64op_label(id))
#define a64insn_ble(actx, id) a64insn_b(actx, a64cond_le(), a64op_label(id))
