...
int yuv420_rgb24_lsx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                     int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_bgr24_lsx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                     int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_rgba32_lsx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                      int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_bgra32_lsx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                      int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_argb32_lsx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                      int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_abgr32_lsx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                      int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);
...
int yuv420_rgb24_lasx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                      int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_bgr24_lasx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                      int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_rgba32_lasx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                       int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_bgra32_lasx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                       int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_argb32_lasx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                       int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);

int yuv420_abgr32_lasx(SwsContext *c, const uint8_t *src[], const int srcStride[],
                       int srcSliceY, int srcSliceH, uint8_t *dst[], const int dstStride[]);
