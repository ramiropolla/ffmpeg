...
typedef enum SwsUOpType {
    ...
    /* Data conversion / manipulation uops */
    SWS_UOP_SWAP_BYTES,      /* swap byte order in component */
    SWS_UOP_EXPAND_BIT,      /* expand single bits to full range */
    SWS_UOP_EXPAND_PAIR,     /* expand bytes in pairs (16 bit) */
    SWS_UOP_EXPAND_QUAD,     /* expand bytes in quads (32 bit) */
    SWS_UOP_PERMUTE,         /* rearrange components (mask = non-identity) */
    SWS_UOP_COPY,            /* copy components (mask = non-identity) */
    SWS_UOP_CONVERT,         /* plain type conversion; mask = affected */
