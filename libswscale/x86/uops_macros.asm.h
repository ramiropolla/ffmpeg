...
#define DEF_MACRO(UOP, TYPE)                            \
    %define DECL_##UOP##_##TYPE(MACRO)                  \
    MULTILINE FOR_SWS_UOP_##UOP##_##TYPE(DECL_OP_MACRO) \
    dummy
...
#define DEF_ALL_MACROS(TYPE)                \
    ...
    {DEF_MACRO(CONVERT,        U8_##TYPE)}, \
    {DEF_MACRO(CONVERT,       U16_##TYPE)}, \
    {DEF_MACRO(CONVERT,       U32_##TYPE)}, \
    {DEF_MACRO(CONVERT,       F32_##TYPE)}
