...
%macro decl_filter_ops 1 ; type
    decl_suffix _4x4,   DECL_READ_PLANAR_FH_%1 (READ_PLANAR_FH_4X4)

    DECL_READ_PLANAR_FH_%1      (READ_PLANAR_FH)
    DECL_READ_PLANAR_FV_%1      (READ_PLANAR_FV)
    DECL_READ_PLANAR_FV_FMA_%1  (READ_PLANAR_FV_FMA)
%endmacro
