...
SWS_FOR_STRUCT(READ_PACKED,     TYPE, DECL_ENTRY, EXT, NULL, setup_rw_packed)   \
SWS_FOR_STRUCT(READ_NIBBLE,     TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(READ_BIT,        TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(WRITE_PACKED,    TYPE, DECL_ENTRY, EXT, NULL, setup_rw_packed)   \
SWS_FOR_STRUCT(WRITE_NIBBLE,    TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(WRITE_BIT,       TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(SWAP_BYTES,      TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(EXPAND_BIT,      TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(PERMUTE,         TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(COPY,            TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(SCALE,           TYPE, DECL_ENTRY, EXT, NULL, setup_scale)       \
SWS_FOR_STRUCT(ADD,             TYPE, DECL_ENTRY, EXT, NULL, ff_sws_setup_vec4) \
SWS_FOR_STRUCT(MIN,             TYPE, DECL_ENTRY, EXT, NULL, ff_sws_setup_vec4) \
SWS_FOR_STRUCT(MAX,             TYPE, DECL_ENTRY, EXT, NULL, ff_sws_setup_vec4) \
SWS_FOR_STRUCT(UNPACK,          TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(PACK,            TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(LSHIFT,          TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(RSHIFT,          TYPE, DECL_ENTRY, EXT, NULL, NULL)              \
SWS_FOR_STRUCT(LINEAR_FMA,      TYPE, DECL_ENTRY, EXT, NULL, setup_linear)      \
SWS_FOR_STRUCT(DITHER,          TYPE, DECL_ENTRY, EXT, NULL, setup_dither)      \
/* end of macro */

#define REF_OPS_COMMON(EXT, TYPE)                                               \
    SWS_FOR(READ_PACKED,    TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(READ_NIBBLE,    TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(READ_BIT,       TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(WRITE_PACKED,   TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(WRITE_NIBBLE,   TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(WRITE_BIT,      TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(SWAP_BYTES,     TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(EXPAND_BIT,     TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(PERMUTE,        TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(COPY,           TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(SCALE,          TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(ADD,            TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(MIN,            TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(MAX,            TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(UNPACK,         TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(PACK,           TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(LSHIFT,         TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(RSHIFT,         TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(LINEAR_FMA,     TYPE, REF_ENTRY, EXT)                               \
    SWS_FOR(DITHER,         TYPE, REF_ENTRY, EXT)                               \
    /* end of macro */

#define DECL_TABLE_U8(EXT, SIZE, FLAG)                                          \
DECL_OPS_COMMON(EXT, U8)                                                        \
SWS_FOR_STRUCT(READ_PLANAR,     U8, DECL_ENTRY, EXT, NULL, NULL)                \
SWS_FOR_STRUCT(WRITE_PLANAR,    U8, DECL_ENTRY, EXT, NULL, NULL)                \
SWS_FOR_STRUCT(CLEAR,           U8, DECL_ENTRY, EXT, NULL, setup_clear)         \
                                                                                \
static const SwsOpTable ops_u8##EXT = {                                         \
    ...
    .entries = {                                                                \
        ...
        SWS_FOR(READ_PLANAR,    U8, REF_ENTRY, EXT)                             \
        SWS_FOR(WRITE_PLANAR,   U8, REF_ENTRY, EXT)                             \
        SWS_FOR(CLEAR,          U8, REF_ENTRY, EXT)                             \
        NULL                                                                    \
    },                                                                          \
};
...
SWS_FOR_STRUCT_CONVERT(U8, U16, DECL_ENTRY, EXT, NULL, NULL)                    \
SWS_FOR_STRUCT_CONVERT(U16, U8, DECL_ENTRY, EXT, NULL, NULL)                    \
SWS_FOR_STRUCT(EXPAND_PAIR, U8, DECL_ENTRY, EXT, NULL, NULL)                    \
                                                                                \
static const SwsOpTable ops_u16##EXT = {                                        \
    ...
    .entries = {                                                                \
        ...
        SWS_FOR_CONVERT(U8, U16, REF_ENTRY, EXT)                                \
        SWS_FOR_CONVERT(U16, U8, REF_ENTRY, EXT)                                \
        SWS_FOR(EXPAND_PAIR, U8, REF_ENTRY, EXT)                                \
        NULL                                                                    \
    },                                                                          \
};
...
SWS_FOR_STRUCT_CONVERT(U8,  U32, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT_CONVERT(U32,  U8, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT_CONVERT(U16, U32, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT_CONVERT(U32, U16, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT(EXPAND_QUAD,  U8, DECL_ENTRY, EXT, NULL, NULL)                   \
                                                                                \
static const SwsOpTable ops_u32##EXT = {                                        \
    ...
    .entries = {                                                                \
        ...
        SWS_FOR_CONVERT(U8,  U32, REF_ENTRY, EXT)                               \
        SWS_FOR_CONVERT(U32, U8,  REF_ENTRY, EXT)                               \
        SWS_FOR_CONVERT(U16, U32, REF_ENTRY, EXT)                               \
        SWS_FOR_CONVERT(U32, U16, REF_ENTRY, EXT)                               \
        SWS_FOR(EXPAND_QUAD,  U8, REF_ENTRY, EXT)                               \
        NULL                                                                    \
    },                                                                          \
};
...
SWS_FOR_STRUCT_CONVERT(U8,  F32, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT_CONVERT(F32,  U8, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT_CONVERT(U16, F32, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT_CONVERT(F32, U16, DECL_ENTRY, EXT, NULL, NULL)                   \
SWS_FOR_STRUCT(READ_PLANAR_FH,  U8, DECL_ENTRY, EXT, NULL, setup_filter_h)      \
SWS_FOR_STRUCT(READ_PLANAR_FH, U16, DECL_ENTRY, EXT, NULL, setup_filter_h)      \
SWS_FOR_STRUCT(READ_PLANAR_FH, F32, DECL_ENTRY, EXT, NULL, setup_filter_h)      \
SWS_FOR_STRUCT(READ_PLANAR_FH,  U8, DECL_ENTRY, _4x4##EXT,                      \
               check_filter_h_4x4, setup_filter_h_4x4)                          \
SWS_FOR_STRUCT(READ_PLANAR_FH, U16, DECL_ENTRY, _4x4##EXT,                      \
               check_filter_h_4x4, setup_filter_h_4x4)                          \
SWS_FOR_STRUCT(READ_PLANAR_FH, F32, DECL_ENTRY, _4x4##EXT,                      \
               check_filter_h_4x4, setup_filter_h_4x4)                          \
SWS_FOR_STRUCT(READ_PLANAR_FV,  U8, DECL_ENTRY, EXT, NULL, setup_filter_v)      \
SWS_FOR_STRUCT(READ_PLANAR_FV, U16, DECL_ENTRY, EXT, NULL, setup_filter_v)      \
SWS_FOR_STRUCT(READ_PLANAR_FV, F32, DECL_ENTRY, EXT, NULL, setup_filter_v)      \
SWS_FOR_STRUCT(READ_PLANAR_FV_FMA,  U8, DECL_ENTRY, EXT, NULL, setup_filter_v)  \
SWS_FOR_STRUCT(READ_PLANAR_FV_FMA, U16, DECL_ENTRY, EXT, NULL, setup_filter_v)  \
SWS_FOR_STRUCT(READ_PLANAR_FV_FMA, F32, DECL_ENTRY, EXT, NULL, setup_filter_v)  \
                                                                                \
static const SwsOpTable ops_f32##EXT = {                                        \
    ...
    .entries = {                                                                \
        ...
        SWS_FOR_CONVERT(U8,  F32, REF_ENTRY, EXT)                               \
        SWS_FOR_CONVERT(F32, U8,  REF_ENTRY, EXT)                               \
        SWS_FOR_CONVERT(U16, F32, REF_ENTRY, EXT)                               \
        SWS_FOR_CONVERT(F32, U16, REF_ENTRY, EXT)                               \
        SWS_FOR(READ_PLANAR_FH,  U8, REF_ENTRY, _4x4##EXT)                      \
        SWS_FOR(READ_PLANAR_FH, U16, REF_ENTRY, _4x4##EXT)                      \
        SWS_FOR(READ_PLANAR_FH, F32, REF_ENTRY, _4x4##EXT)                      \
        SWS_FOR(READ_PLANAR_FH,  U8, REF_ENTRY, EXT)                            \
        SWS_FOR(READ_PLANAR_FH, U16, REF_ENTRY, EXT)                            \
        SWS_FOR(READ_PLANAR_FH, F32, REF_ENTRY, EXT)                            \
        SWS_FOR(READ_PLANAR_FV,  U8, REF_ENTRY, EXT)                            \
        SWS_FOR(READ_PLANAR_FV, U16, REF_ENTRY, EXT)                            \
        SWS_FOR(READ_PLANAR_FV, F32, REF_ENTRY, EXT)                            \
        SWS_FOR(READ_PLANAR_FV_FMA,  U8, REF_ENTRY, EXT)                        \
        SWS_FOR(READ_PLANAR_FV_FMA, U16, REF_ENTRY, EXT)                        \
        SWS_FOR(READ_PLANAR_FV_FMA, F32, REF_ENTRY, EXT)                        \
        NULL                                                                    \
    },                                                                          \
};
