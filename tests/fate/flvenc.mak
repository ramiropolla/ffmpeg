...
fate-flv-add_keyframe_index: CMD = transcode "lavfi -graph testsrc=r=7:n=2:d=20" "foo" flv "-vf scale -c:v flv1 -g 7 -flvflags add_keyframe_index" "-c copy -t 0.1" "-show_entries format_tags"
