...
fate-sws-unscaled: CMD = run libswscale/tests/swscale$(EXESUF) -scaler_flags unscaled -legacy -1 -v 16

# Run only 10% of swscale tests to keep the run time short, and only check for failure
FATE_LIBSWSCALE-$(CONFIG_UNSTABLE) += fate-sws-unstable
fate-sws-unstable: libswscale/tests/swscale$(EXESUF)
fate-sws-unstable: CMD = run libswscale/tests/swscale$(EXESUF) -p 0.1 -legacy -1 -v 16
